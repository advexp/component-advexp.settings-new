...
namespace Sample.CognitoSyncSettings.iOS
{
    ...
    public class AppDelegate : UIApplicationDelegate
    {
        ...
        public override bool FinishedLaunching(UIApplication application, NSDictionary launchOptions)
        {
            ...
            Facebook.CoreKit.Settings.AppID = Constants.FacebookAppId;
            Facebook.CoreKit.Settings.DisplayName = Constants.FacebookAppName;

            CognitoSyncSettingsConfiguration.IdentityPoolId = Constants.CognitoSyncIdentityPoolId;
            CognitoSyncSettingsConfiguration.ProviderName = Constants.CognitoSyncProviderName;
            CognitoSyncSettingsConfiguration.IdentityRegion = Constants.CognitoSyncIdentityRegion;
            CognitoSyncSettingsConfiguration.SyncRegion = Constants.CognitoSyncRegion;
