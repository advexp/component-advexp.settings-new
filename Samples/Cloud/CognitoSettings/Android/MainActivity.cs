...
namespace Sample.CognitoSyncSettings.Android
{
    ...
    public class MainActivity :  FragmentActivity, ICognitoSyncEventsListerner
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
			...
			/*
            Button loginWithFacebook = FindViewById<Button>(Resource.Id.loginWithFacebook);
            loginWithFacebook.Click += delegate
            {
                StartActivity(typeof(CognitoPreferencesActivity));
            };
            */
        }
