...
namespace TDD
{
    ...
    public class SerializerPriorityTest
    {
        ...
        //------------------------------------------------------------------------------
        public void SerializerAction(Type serializerType, TDDData.SerializerActions action, string settingName, bool secure)
        {
        ...
        {
            var method = type.BaseType.GetMethod(func, Type.EmptyTypes);
        ...
        {
            Test("Load", TDDData.SerializerActions.Load);
        }
        ...
        {
            Test("Save", TDDData.SerializerActions.Save);
        }
        ...
        {
            Test("Delete", TDDData.SerializerActions.Delete);
        }
    }
}
