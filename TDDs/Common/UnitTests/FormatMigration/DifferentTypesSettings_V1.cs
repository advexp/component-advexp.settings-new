...
namespace TDD
{
    public class DifferentTypesLocalSettings_V1 : Advexp_V1.Settings<TDD.DifferentTypesLocalSettings_V1>
    {
        ...
        //------------------------------------------------------------------------------
        public DifferentTypesLocalSettings_V1()
        {
            RandomizeValues();
        }
    ...
    public class DifferentTypesSecureSettings_V1 : Advexp_V1.Settings<TDD.DifferentTypesSecureSettings_V1>
    {
        ...
        //------------------------------------------------------------------------------
        public DifferentTypesSecureSettings_V1()
        {
            RandomizeValues();
        }
